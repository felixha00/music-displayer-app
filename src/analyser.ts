function main(analyser) {
  ...
  this.buildCanvas = function () {
    ...
    this.canvas.style.cssText =
      'position:fixed;z-index:999999;pointer-events: none;display:block;width:100%;bottom:1px;';
  ...
  this.render = function () {
    ...
    if (!this.settings.randomColorOnStartup) {
      ...
      l.addColorStop(
        1,
        `rgb(${this.randomNumber(10, 200)},${this.randomNumber(
          10,
          200
        )},${this.randomNumber(10, 200)})`
      );
      l.addColorStop(
        0.2,
        `rgb(${this.randomNumber(10, 200)},${this.randomNumber(
